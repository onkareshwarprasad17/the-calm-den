...
function prepareData(startData, stays) {
  // loop through the startData and increment the value property when the respective field is present
  ...
  // reduce the stays data and filter only the ones for which value prop > 0
  const data = stays
    .reduce((acc, cur) => {
